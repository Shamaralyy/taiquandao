    ...
    <view class="content">
      <view class="logo-bg">
        ...
        <view style="padding-left: 40rpx; padding-top: 40rpx">
          ...
          <view
            style="font-size: x-large; font-weight: 700; padding-top: 10rpx"
            >{{ name }}</view
          >
          <view style="font-size: xx-small; padding-top: 20rpx"
            >|{{ type }}|</view
          >
        </view>
        <!-- 第一个小矩形 -->
        ...
        <view style="padding-left: 40rpx; padding-top: 30rpx">
          <view class="rectange_low" style="background-color: #fff"></view>
          <view style="font-size: larger; font-weight: 600; padding-top: 15rpx"
            >正在进行</view
          >
      ...
      <view style="padding-left: 40rpx; padding-top: 50rpx">
        ...
        <view style="padding-top: 10rpx">
          ...
          <view class="third_right" v-for="item in sponsor" :key="item">{{
            item
          }}</view>
        </view>
      </view>
...
function navToEnroll(hasPsw) {
  //hasPsw为false时 在报名页面点击后三个页面需要输入报名密码
  let enrollObj = {
    id: id.value,
  ...
  uni.navigateTo({
    url:
      "/pages/core/enroll/index?id=" +
      encodeURIComponent(JSON.stringify(id.value)) +
      "&password=" +
      encodeURIComponent(JSON.stringify(password.value)) +
      "&data=" +
