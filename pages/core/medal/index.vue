<template>
  <view class="individual">
    <view class="msg">
      ...
      <picker
        class="msg_picker msg_picker1"
        mode="selector"
        :range="selectData.comType"
        :value="selectData.comIndex"
      ...
      <picker
        class="msg_picker msg_picker2"
        mode="selector"
        :range="selectData.marArr"
        :value="selectData.marIndex"
        @change="marPickerChange"
      >
        <view>
...
import { showMatchPlayersAPI } from "@/API/medal.js";
...
onMounted(async () => {
  try {
    let res = await showMatchPlayersAPI(9999, 3);
