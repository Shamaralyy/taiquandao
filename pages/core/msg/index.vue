<template>
	<view v-if="type===1" class="msg-box">
		...
		<view class="msg-text"><text>姓名:</text><text>{{userInfo.name}}</text></view>
		<view class="msg-text"><text>性别:</text><text>男</text></view>
		<view class="msg-text"><text>道馆名称:</text><text>{{userInfo.org}}</text></view>
		<view class="msg-text"><text>身份证号:</text><text>500106200308040323</text></view>
	...
	<view v-if="type===2">
		<view class="stu-container">
			<view class="stu">
				<image class="avatar ava" :src="userInfo.photo" mode=""></image><text>学生</text>
			</view>
			<view class="stu">
				<image class="avatar ava" :src="userInfo.photo" mode=""></image><text>学生</text>
			</view>
