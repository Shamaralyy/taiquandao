  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        x: common_vendor.sr(message, "df00713c-0", {
          "k": "message"
        }),
        y: common_vendor.p({
          type: "message"
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/刘懿莹/框架/vue/taiquandao/tqd/pages/core/marCert/index.vue"]]);
